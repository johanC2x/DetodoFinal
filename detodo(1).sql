...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-05-2015 a las 14:27:01
...
(20, 1, 'Que anime es ese', b'1', 21),
(21, 2, 'ese es Tokio Ghoul ya termino la temporada 2 y esta por salir la tercera', b'1', 21),
(22, 1, 'mmmm genial tendras algun link', b'1', 21),
(23, 1, 'si espera https://www.youtube.com/watch?v=3C-k_3dcfNY', b'1', 21),
(24, 2, 'espera pero ese no fui yo quien lo dijo', b'1', 21),
(25, 1, 'pero no fuiste en serio', b'1', 21),
(26, 2, 'mmmmm', b'1', 21),
(27, 1, 'como', b'1', 21),
(28, 2, 'no ahora ya esta todo bien', b'1', 21),
(29, 1, 'si asi parece', b'1', 21);
...
INSERT INTO `usuario` (`idusuario`, `nombre`, `apepat`, `apemat`, `edad`, `nickname`, `contrasenia`, `flgstatus`, `direccion`, `flgActivo`, `mail`) VALUES
(1, 'johan', 'Cañari', 'Huamani', 21, 'johan', '123456', b'1', '1', b'1', NULL),
(2, 'joel', 'Espinoza', 'Huamani', 25, 'joel', '123456', b'1', '1', b'1', NULL),
(3, 'ana', 'Suarez', 'Peña', 25, 'ana', '123456', b'1', 'Villa Maria del Triunfo', NULL, NULL),
(4, 'Fernando', 'Rodriguez', 'Espino', 26, 'Fernando', '123456', b'1', 'Villa Maria del Triunfo', b'0', NULL),
(5, 'frits', 'Inca ', 'Damian', 30, 'padre', '123456', b'1', 'San Bartolo', b'0', NULL),
(6, 'Juan', 'Perez', 'casa', 21, 'Juan', '123456', b'1', 'Villa Maria del Triunfo', NULL, NULL),
(9, 'Joel', 'Espinoza', 'Huamani', 25, 'joel', '123456', b'1', 'Villa Maria del Triunfo', NULL, 'johins2x@gmail.com'),
(10, 'juan', 'Perez', 'Ramos', 25, 'juan', '123456', b'1', 'Villa Maria del Triunfo', NULL, 'johins2x@gmail.com');
...
--
ALTER TABLE `post`
MODIFY `idpost` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
